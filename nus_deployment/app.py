...
def home():
    ...
    return render_template("homepage.html", type="flair", result="")
...
def upload(name):
    ...
    return render_template("homepage.html", type="seg", result="")
...
def predict(name):
    ...
    if(prediction>=0.5):
        ...
        grade='LGG'
    result="This file {} has tumor of type {}".format(name2, grade)
